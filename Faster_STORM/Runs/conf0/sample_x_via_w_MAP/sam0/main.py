...
# parameters
sam = {
    'sam_dir' : PureWindowsPath(r'Faster_STORM\Runs\conf0\sample_x_via_w_MAP\sam0'),
    'n_cores' : 2,
    'sam_dir_w_samples' : PureWindowsPath(r'Faster_STORM\Runs\conf0\sample_w_MAP\sam0.npy'),
}

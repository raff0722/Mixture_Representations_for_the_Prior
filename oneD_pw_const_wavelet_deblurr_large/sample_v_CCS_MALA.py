# samples CCS-reduced v with MALA
...
def main(par, sam, ch):
    ...
    log_pdf_mixing.init_log_pdf_red_v(delta, til_A, til_y, sam['I'], offline_path=sam['sam_dir']/'Schur_precomp')
    log_pdf_grad_generator = log_pdf_mixing.log_pdf_red_v(delta, til_A, til_y, sam['I'], offline_path=sam['sam_dir']/'Schur_precomp', app_Grad=True)
    log_pdf_grad = lambda v: log_pdf_grad_generator(v, pdf=True, grad=True, Hess=False)[:2]
